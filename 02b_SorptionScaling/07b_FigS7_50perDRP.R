...
# a version of Fig. 3 assuming colloid-P:DRP = 0.5
...
# Data ----
maum <- read.csv(file.path(here::here("04_generatedData"),"06b_Scale2WVall_MjHf_50perDRP.csv"), row.names = 1) %>% 
          mutate(Yg = ifelse(Y >=2003, "G2003", "L2003"),
                 Yg = fct_relevel(Yg,"L2003", "G2003"))

maumCyanos <- read.csv(file.path(here::here("04_generatedData"),"06b_Scale2WVall_MjHf_cyanos_50perDRP.csv"), row.names = 1) %>% 
...
summary(maum$gPsorbP_MjHf_50per/1e6)
summary(maum$perSorbP_50per)
...
png("05_Figures/07b_FigS7_50perDRP.png", units = "in", height = 12, width = 14, res = 300)
grid.newpage()
grid.draw(Fig3.gtf)
...
# save ----
# write.csv(maum, file.path(here::here("04a_generatedDataOnGit"), "07_Fig3Dat_maum_50col.csv"))
# write.csv(maumCyanos, file.path(here::here("04a_generatedDataOnGit"), "07_Fig3Dat_maumCyano_50col.csv"))

# save.image(file.path(here::here("03_Rdata"), "07b_Fig4_50perDRP_Rdata"))
# load(file.path(here::here("03_Rdata"), "07b_Fig4_50perDRP_Rdata"))
